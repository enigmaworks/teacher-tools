...
!(function () {
  ...
  document.body.addEventListener("click", function (t) {
    t.target.closest(".Header") || e.classList.remove("Header-search--expanded");
  }),
    document.querySelector(".Header-menu a[href*=search]").addEventListener("click", function (t) {
      e.classList.toggle("Header-search--expanded"),
        e.classList.contains("Header-search--expanded") && e.querySelector("input").focus(),
        t.preventDefault();
    });
})(),
  (function () {
  ...
  (function () {
    ...
    for (var t = e.length - 1; t >= 0; t--)
      e[t].addEventListener("click", function () {
        ...
        e
          ? (this.setAttribute("aria-expanded", "false"), t.setAttribute("hidden", "hidden"))
          : (this.setAttribute("aria-expanded", "true"), t.removeAttribute("hidden"));
      });
  })(),
  (function () {
        ...
        e.scrollIntoView({ behavior: "smooth" }),
          setTimeout(function () {
            e.classList.add("RandOptions--highlight"),
              setTimeout(function () {
                e.classList.remove("RandOptions--highlight"), e.querySelector("[name]").focus();
              }, 200);
          }, 300);
      });
  })(),
...
window.addEventListener("rand_ran", function () {
      ...
      (e.onerror = function () {
        ...
        t.setAttribute("class", "whine"),
          ...
          document.querySelector("[data-support=unblock]").addEventListener("click", function () {
            gtag("event", "support", { event_label: "unblock" });
          }),
            ...
            e.scrollIntoView({ behavior: "smooth" }),
              setTimeout(function () {
                ...
                setTimeout(function () {
                  ...
                  for (var n = t.length - 1; n >= 0; n--) t[n].classList.add("button--yo");
                  setTimeout(function () {
                    e.classList.remove("button--yo");
                    for (var n = t.length - 1; n >= 0; n--) t[n].classList.remove("button--yo");
                  }, 300);
                }, 300);
              }, 300);
          });
  ...
  (function () {
    ...
    for (var r = o.length - 1; r >= 0; r--)
      o[r].addEventListener("focus", function () {
        for (var e = n.length - 1; e >= 0; e--) n[e].removeAttribute("data-help");
      });
  })(),
  (function () {
    var e = rand + "-remember",
  ...
  (function () {
    ...
    const t = function (t, n) {
        ...
        a.setAttribute("value", r), (a.innerHTML = (n ? "&nbsp;&nbsp;" : "") + o), e.appendChild(a);
      },
    ...
    const a = document.querySelector("link[rel=canonical]").getAttribute("href"),
